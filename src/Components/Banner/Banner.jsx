...
const Banner = () => {
    return (
        <div className='w-3/4 mx-auto  md:flex gap-15 justify-between items-center py-15'>
            <div className='space-y-4'>
                ...
                <h2 className='text-[#101727] font-extrabold text-6xl'>Supercharge Your Digital Workflow</h2>
